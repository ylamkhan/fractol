...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/01/18 04:15:18 by ylamkhan          #+#    #+#             */
/*   Updated: 2023/01/18 04:27:15 by ylamkhan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	miniburning(int x, int y, t_fractal *burning)
{
	...
	i = 0;
	burning->c.x = (x + burning->xarrow) / burning->zoom* (1.0 + 2.5) / (burning->width - 1) - 2.5;
	burning->c.y = (y + burning->yarrow) / burning->zoom* (1.0 + 1.0) / (burning->width - 1) - 1.0;
	z0 = burning->c.x;
	z1 = burning->c.y;
